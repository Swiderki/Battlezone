...
class Radar implements GUIElement {
    ...
    public render(ctx: CanvasRenderingContext2D): void {
        ...
        ctx.fillRect(centerX - this.radius - outerPitchWidth, this.radius + this.topMargin, outerPitchWidth, this.thickness);
        ...
        ctx.fillRect(
            ...
            this.radius + this.topMargin + this.player.position.z - enemy.position.z,
            3,
            3
        );
        }
